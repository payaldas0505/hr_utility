...
urlpatterns = [
    ...
    path('dashboard/get_change_password/',
         GetChangePasswordPageView.as_view(), name="get_change_password"),
    ...
    path('dashboard/user_management/',
         UserManagementDashboardPageView.as_view(), name="user_management"),

    path('dashboard/user_management/add_user_data/',
         AddUserFormView.as_view(), name="add_user_data"),

    path('dashboard/user_management/add_user/',
         AddUserPageView.as_view(), name="add_user"),
    ...
    path('dashboard/template_management_data/',
         TemplateManagementDashboard.as_view(), name="template_management_data"),

    path('dashboard/template_management/',
         TemplateManagementDashboardPageView.as_view(), name="template_management"),

    path('dashboard/template_management/add_template_data/',
         NewGenDocxView.as_view(), name='new_generate_docx_data'),

    path('dashboard/template_management/add_template/',
         AddTemplatePageView.as_view(), name='new_generate_docx'),
    ...
    path('dashboard/document_template_dropdown/',
         DocumentTeamplateDropdown.as_view(), name='document_template_dropdown'),
    ...
    path('dashboard/getallfilltemplate',
